...
uicontrol('parent',welcome.panel,'style','pushbutton',...%KM
            'String','Load previous experiment','fontsize',12,...
            'units','normalized','Position', [.35 .35 .3 .09],...
            'callback',{@loadPreviousExpt});
