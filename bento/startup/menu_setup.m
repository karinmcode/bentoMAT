...
labels = char('&File',...
                 '>L&oad experiment^o',...
                 '>&Edit experiment^e',...
                 '>&Open my data folder^d',...
                 '>-------',...
                 '>Manage annotations^a',...
                 '>-------',...
             ...
             '&Annotations',...
                 ...
                 '>Preferences...',...
                 '>Overwrite mode...',...
                 '>Quick save annotations (overwrite existing file)^s',...
             '&Display',...
...
calls = char('','loadExpt(gcf,[],''load'')',...
                'loadExpt(gcf,[],''edit'')',...
                'openMyDataFolder(gcf)',...
             ...
             '','launchColorPick(gcf,[])',...
                ...
                'setAnnotSaveType(gcf)',...preferences
                'setAnnotOverwriteMode(gcf)',...preferences overwrite mode
                'quickSaveAnnotations(gcf)',...preferences overwrite mode
